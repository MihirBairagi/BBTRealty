...
export const faqs = [
    ...
    faqs: [
      {
        ...
        answer: `<p>BBT does not offer inhouse financing but we do provide you with finance  facilities with all the major private banks and financing houses.</p>`,
      },
      {
        question:
          "How long can the tenure for financing be availed and does the ROI fluctuate car to car, territory to territory?",
        answer: `<p>The tenure of financing varies from 2 to 5 years and is judged on the basis of manufacturing year to ownership serial. The ROI is also a part of the tenure of financing and is assessed on the same lines. Territory to territory for us is not a problem as we have financing agents all over the country to help facilitate the process.</p>`,
      },
      {
        question: "How does one gets finance done on these pre-owned cars?",
        answer: `<p>We have tie ups with all the private banks Pan India like ICICI Bank, HDFC Bank, IndusInd Bank, Yes Bank, BMW Financial where in 80% can be financed of the deal value for a tenure of 5 years at diminishing interest rate of 11.50% within 3-4 working days.</p>`,
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question:
          "What Are The Parameters By Which BBT Evaluates Purchase Of A Car That Is Offered For Sale?",
        answer: `<p>We dig deep into every car's history to rule out any car which comes with accidental record , meter tampering , litigation case on car , criminal history of owner, etc. The car goes through 151 check points as per the procurement process.
      ...
      {
        question: "Does BBT Fix Unrepaired Safety Recalls?",
        answer: `<p>Every car sold by BBT comes with 151 check points where a complete dedicated after sales team is on floor to make sure that the vehicle comes with complete track records and everything is functional. Before you purchase a car from BBT, our sales consultant will review with you a Check-List report from our after-sales team and VIN-No for the car by which you can get the complete track record and previous service history checked from the authorized car dealership. There are few cars which comes with previous dealership warranty valid on it so those cars get serviced at their respective dealership only. Those cars which are out of warranty gets complete service assistance at BBT-Workshop with assistance to its reach over Pan-India.</p>`,
      },
    ],
  },
];
